...
export function main(): void {
  ...
  if (!engine.startup({
    ...
    ui_sprites: {
      ...
      buttonselected_regular: { atlas: 'ui', name: 'buttonselected' },
      buttonselected_down: { atlas: 'ui' },
      buttonselected_rollover: { atlas: 'ui' },
      buttonselected_disabled: { atlas: 'ui' },
      panel: { atlas: 'ui' },
      menu_entry: { atlas: 'ui' },
      ...
      scrollbar_bottom: { atlas: 'ui' },
      scrollbar_trough: { atlas: 'ui' },
      scrollbar_top: { atlas: 'ui' },
      scrollbar_handle_grabber: { atlas: 'ui' },
      scrollbar_handle: { atlas: 'ui' },
    },
