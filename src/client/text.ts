...
export const TEXT = {
  ...
  RASA_SECRET: 'Uh... what is that thing and is that... a chicken on its head?  I don\'t think I\'m supposed to be here...',
  ...
  RASA_ORB2_ACQUIRED: 'Finally, I held the power of [c=red]Flame[/c] in my claws.  Would I become a [c=red]Red Dragon[/c] like my defeated foe?\n\n' +
    'No I would not!  My goals were so much more grandiose.  I took all three [c=green]Orbs[/c] [c=blue]of[/c] [c=red]Power[/c] at once, combined them within myself, and transformed into the [c=red]Multi-[/c][c=green]Chromatic[/c] [c=blue]Dragon[/c] that I am today!\n\nIt\'s "Mutli-Chromatic Dragon", not "Rainbow Dragon".  Really, please stop calling me that.',
  ...
  RASA_BOSS3_VICTORY: 'I limped away from the fight, just as surprised as you surely are, that I was the victor.\n\n' +
    'I had proved my worth as the ultimate\n[c=red]R[/c][c=green]a[/c][c=blue]i[/c][c=red]n[/c][c=green]b[/c][c=blue]o[/c][c=red]w[/c], err, [c=red]Multi-[/c][c=green]Chromatic[/c] [c=blue]Dragon[/c].\n\n',
